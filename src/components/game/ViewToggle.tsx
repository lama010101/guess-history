...
const ViewToggle = ({ activeView, onToggle, imageSrc }: ViewToggleProps) => {
  ...
  const mapPreviewImage = 'https://api.mapbox.com/styles/v1/mapbox/streets-v11/static/10,50,4,0,0/75x75?access_token=pk.eyJ1IjoibWFwYm94IiwiYSI6ImNpejY4M29iazA2Z2gycXA4N2pmbDZmangifQ.-g_vE53SD2WrJ6tFX7QHmA';
