...
>(
  (
    ...
    React.useEffect(() => {
      ...
      if (isMobile) {
        // Access the DOM element by using the containerRef from EmblaViewportRefType
        // which has the element property to get the DOM node
        const element = carouselRef?.viewport?.element || null;
